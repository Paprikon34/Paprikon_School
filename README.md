...
| **07** | **[Library Management System](./07_library_management_system)** | 20.04.2026 | C++, OOP, File I/O | ⭐⭐⭐⭐ | ✅ Hotovo |
| **08** | **[Repo Analytics](./08_repo_analytics)** | 12.05.2026 | Python, Analytics, Automation | ⭐⭐⭐ | 🚀 V provozu |
...
*   **Automatické čištění**: Interní nástroje (např. automatický bot v projektu 02 a analytika v projektu 08) jsou konfigurovány tak, aby ukládaly výsledky své práce výhradně do svých přidělených adresářů.
...
| :--- | :--- |
| **Počet projektů** | 8 |
| **Celkem řádků kódu** | 3469 |
| **Celkem dokumentace** | 773 řádků |
| **Velikost repozitáře** | ~21.53 MB |
| **Hlavní jazyky** | Python, Markdown, C++ |
